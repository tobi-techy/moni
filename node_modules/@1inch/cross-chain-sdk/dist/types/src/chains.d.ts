...
export declare const isEvm: (chain: SupportedChain) => chain is EvmChain;
export declare const isSolana: (chain: SupportedChain) => chain is SolanaChain;
export {};
