...
const RobinhoodTrueERC20 = EvmAddress.fromString('0x40c0b7e8018cca1eb8d913b75b1b20cfd89b8d5b');
// Monad, Cronos and HyperEVM use a new deployer, so they share addresses which differ from other chains
const MonadCronosHyperevmTrueERC20 = EvmAddress.fromString('0x175a30f81eade2d75b4d1d5fc750131877355d21');
...
// Robinhood chain uses its own CREATE3 deployer, so addresses differ from other chains
const ESCROW_RH_FACTORY_ADDRESS = EvmAddress.fromString('0x50d26ea1e2460b3a42ff47466b955fc6bd906013');
const ESCROW_RH_SRC_IMPLEMENTATION_ADDRESS = EvmAddress.fromString('0xb540a42ca356f30307439b60647b5704d57f45ee');
const ESCROW_RH_DST_IMPLEMENTATION_ADDRESS = EvmAddress.fromString('0x3875faf11ccef1dca35d190bc41cd47895dc18b2');
// Monad, Cronos and HyperEVM use a new deployer, so they share addresses which differ from other chains
const ESCROW_MCH_FACTORY_ADDRESS = EvmAddress.fromString('0x8e6c3c2e2631de0a1d4fd46a15f79a1373486fa4');
const ESCROW_MCH_SRC_IMPLEMENTATION_ADDRESS = EvmAddress.fromString('0x25fb2e7a56db5a3f04be5e7a728977e889e62a3c');
const ESCROW_MCH_DST_IMPLEMENTATION_ADDRESS = EvmAddress.fromString('0x715bb4091abccacef523a6069b4f0e2678a352f2');
