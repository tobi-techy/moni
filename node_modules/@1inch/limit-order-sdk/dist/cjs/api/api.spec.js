...
describe('Api', function() {
    ...
    describe('getOrdersByMaker', function() {
        var mockMakerAddress = new _address.Address('0x1234567890123456789012345678901234567890');
        var mockResponse = {
            items: [
                {
                ...
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                            ...
                            makerAsset = new _address.Address('0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48');
                            takerAsset = new _address.Address('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2');
                            return [
                                4,
                                api.getOrdersByMaker(mockMakerAddress, {
                                    pager: pager,
                ...
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                            ...
                            makerAsset = new _address.Address('0xdac17f958d2ee523a2206206994597c13d831ec7');
                            takerAsset = new _address.Address('0x6b175474e89094c44da98b954eedeac495271d0f');
                            return [
                                4,
                                api.getAllOrders({
                                    pager: pager,
    ...
    describe('getFeeParams', function() {
        var mockFeeInfo = {
            whitelist: {},
            feeBps: 30,
        ...
        it('should fetch fee params', function() {
            return _async_to_generator(function() {
                var makerAsset, takerAsset, result;
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                        ...
                        case 1:
                            result = _state.sent();
                            expect(mockHttpConnector.get).toHaveBeenCalledWith('https://api.test.com/1/fee-info?makerAsset=0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48&takerAsset=0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2&makerAmount=1000000&takerAmount=2000000000000000', {
                                Authorization: 'Bearer test-auth-key'
                            });
