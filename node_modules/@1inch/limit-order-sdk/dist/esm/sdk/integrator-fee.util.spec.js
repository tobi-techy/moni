...
describe('buildIntegratorFeeFromFeeInfo', function() {
    ...
    it('returns ZERO when integrator fee fields are absent', function() {
        var fee = buildIntegratorFeeFromFeeInfo({
