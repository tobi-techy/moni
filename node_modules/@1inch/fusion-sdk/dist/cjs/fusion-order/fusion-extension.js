...
var _targetonlyinteraction = require("./target-only-interaction.js");
...
var FusionExtension = /*#__PURE__*/ function() {
     ...
     */ function buildInteractionData() {
                var _this_extra, _this_extra_fees, _this_extra1, _this_extra_fees1, _this_extra2, _this_extra3;
                ...
                if ((_this_extra3 = this.extra) === null || _this_extra3 === void 0 ? void 0 : _this_extra3.chainedPostInteraction) {
     ...
     */ function fromExtension(extension) {
                ...
                var chainedPostInteraction = interactionBytes.isEmpty() ? undefined : FusionExtension.decodeInteraction(interactionBytes.rest());
     ...
     */ function decodeInteraction(bytes) {
                (0, _assert.default)((0, _byteutils.isHexBytes)(bytes) && (0, _utils.trim0x)(bytes).length >= 40, "invalid interaction ".concat(bytes, ": must be valid hex bytes starting with a 20 bytes target address"));
                var target = _limitordersdk.Address.fromFirstBytes(bytes);
                var data = (0, _utils.add0x)(bytes.slice(42));
                if (data === '0x') {
                    return new _targetonlyinteraction.TargetOnlyInteraction(target);
                }
                return new _limitordersdk.Interaction(target, data);
            }
        }
    ]);
    return FusionExtension;
