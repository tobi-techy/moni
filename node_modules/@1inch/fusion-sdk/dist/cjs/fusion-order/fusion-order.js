...
var FusionOrder = /*#__PURE__*/ function() {
    ...
    function FusionOrder(/**
        ...
        var surplusParams = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : _surplusparams.SurplusParams.NO_FEE, extra = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : FusionOrder.defaultExtra, extension = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : new _fusionextension.FusionExtension(settlementExtensionContract, auctionDetails, whitelist, surplusParams, {
            ...
            chainedPostInteraction: decodeChainedPostInteraction(extra.chainedPostInteraction),
     ...
     */ function fromDataAndExtension(order, extension) {
                var _extra_chainedPostInteraction;
                ...
                var fusionOrder = new FusionOrder(settlementContract, {
                    ...
                    chainedPostInteraction: extra === null || extra === void 0 ? void 0 : (_extra_chainedPostInteraction = extra.chainedPostInteraction) === null || _extra_chainedPostInteraction === void 0 ? void 0 : _extra_chainedPostInteraction.encode(),
...
function encodeChainedPostInteraction(chainedPostInteraction) {
    if (!chainedPostInteraction) {
        return undefined;
    }
    var interactions = (Array.isArray(chainedPostInteraction) ? chainedPostInteraction : [
        chainedPostInteraction
    ]).filter(function(chunk) {
        return (0, _utils.trim0x)(chunk) !== '';
    });
    ...
    try {
        for(var _iterator = interactions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            ...
            (0, _assert.default)((0, _byteutils.isHexBytes)(chunk), "invalid chained post-interaction chunk ".concat(chunk, ": must be 0x-prefixed hex bytes of even length"));
        }
    } catch (err) {
    ...
    var encoded = "0x".concat(interactions.map(_utils.trim0x).join(''));
    // empty concatenation (e.g. `[]`) is an empty tail, i.e. no interaction
    return encoded === '0x' ? undefined : encoded;
}
function decodeChainedPostInteraction(chainedPostInteraction) {
    var encoded = encodeChainedPostInteraction(chainedPostInteraction);
    return encoded ? _fusionextension.FusionExtension.decodeInteraction(encoded) : undefined;
}
