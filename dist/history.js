...
const demoTransactions = [
    {
        ...
        fromToken: 'USDC',
        toToken: 'AAPL',
        fromAmount: 500000000n,
        toAmount: 250000000000000000000n,
    ...
    },
    {
        ...
        fromToken: 'MSFT',
        toToken: 'USDC',
        fromAmount: 500000000000000000000n,
        toAmount: 200000000n,
...
export async function getTransactionHistory(userId, limit = 20) {
    ...
    const history = memory.transactionHistory || demoTransactions;
...
export async function addTransaction(userId, tx) {
    ...
    memory.transactionHistory = history;
    await setTradingMemory(userId, { transactionHistory: history });
    return newTx;
}
export function formatTransactionHistory(txs) {
    if (txs.length === 0) {
...
export function formatTransactionSummary(txs) {
    if (txs.length === 0)
